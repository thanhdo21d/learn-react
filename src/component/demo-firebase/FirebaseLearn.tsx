  ...
  return (
    <div>
      ...
      <form className='mt-10' onSubmit={handelAddData}>
        <p>name</p>
        <input className='border border-gray-500' type="text" name="name" placeholder='enter your name' onChange={(e)=> setName(e.target.value)}/>
          <br />
        <p>price</p>
        <input className='border border-gray-500' type="number" name="price" placeholder='enter your price'
